...
import com.mahya.maisonier.adapter.model.CaracteristiqueAdapter;
import com.mahya.maisonier.entites.Caracteristique;
import com.mahya.maisonier.entites.Caracteristique_Table;
...
public class CaracteristiqueActivity extends BaseActivity implements Paginate.Callbacks, CrudActivity, SearchView.OnQueryTextListener,
        OnItemClickListener {

    private static final int GRID_SPAN = 3;
    private static final String TAG = CaracteristiqueActivity.class.getSimpleName();
    protected RecyclerView mRecyclerView;
    CaracteristiqueAdapter mAdapter;
    FrameLayout fab;
    ...
    private Runnable fakeCallback = new Runnable() {
        ...
        public void run() {
            page++;
            mAdapter.add(Caracteristique.getInitData(itemsPerPage));
            loading = false;
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Caracteristique.caracteristiques.clear();
        Caracteristique.caracteristiques = Caracteristique.findAll();
        setTitle("Caracteristique");
    ...
    public void ajouter(final View view) {
        ...
        final EditText libelle = (EditText) dialog.findViewById(R.id.caracteristique);
    ...
    protected void onDestroy() {
        ...
        mAdapter = null;
        //FlowManager.destroy();
        // Delete.tables(Caracteristique.class);
    }
    ...
    public void modifier(final int id) {
        ...
        final Caracteristique caracteristique = SQLite.select().from(Caracteristique.class).where(Caracteristique_Table.id.eq(id)).querySingle();
        final Dialog dialog = new Dialog(context);
        dialog.setCancelable(false);
        dialog.setContentView(R.layout.add_caracteristiques);
        // Initialisation du formulaire
...
/*
    ...
    protected void setupPagination() {
        ...
        mAdapter = new CaracteristiqueAdapter(this, Caracteristique.getInitData(initItem), (OnItemClickListener) this);
        mRecyclerView.setAdapter(mAdapter);


        ((CaracteristiqueAdapter) mAdapter).setMode(Attributes.Mode.Single);
    ...
    public boolean onQueryTextChange(String query) {
        final List<Caracteristique> filteredModelList = filter(Caracteristique.findAll(), query);
    ...
    private List<Caracteristique> filter(List<Caracteristique> models, String query) {
        query = query.toLowerCase();
        System.out.println(models);
        final List<Caracteristique> filteredModelList = new ArrayList<>();
        for (Caracteristique model : models) {
