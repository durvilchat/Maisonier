...
import com.mahya.maisonier.adapter.model.TypeCautionAdapter;
import com.mahya.maisonier.entites.TypeCaution;
import com.mahya.maisonier.entites.TypeCaution_Table;
...
public class TypeCautionActivity extends BaseActivity implements Paginate.Callbacks, CrudActivity, SearchView.OnQueryTextListener,
        OnItemClickListener {

    private static final int GRID_SPAN = 3;
    private static final String TAG = TypeCautionActivity.class.getSimpleName();
    protected RecyclerView mRecyclerView;
    TypeCautionAdapter mAdapter;
    FrameLayout fab;
    ...
    private Runnable fakeCallback = new Runnable() {
        ...
        public void run() {
            page++;
            mAdapter.add(TypeCaution.getInitData(itemsPerPage));
            loading = false;
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TypeCaution.typeCautions.clear();
        TypeCaution.typeCautions = TypeCaution.findAll();
        setTitle("TypeCaution");
    ...
    private void initView() {
        ...
        if (new TypeCaution().findAll().isEmpty()) {
    ...
    public void ajouter(final View view) {
        ...
        dialog.setContentView(R.layout.add_type_de_caution);
        ...
        valider.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TypeCaution caracteristique = new TypeCaution();
    ...
    protected void onDestroy() {
        ...
        mAdapter = null;
        //FlowManager.destroy();
        // Delete.tables(TypeCaution.class);
    }
    ...
    public void modifier(final int id) {
        ...
        final TypeCaution caracteristique = SQLite.select().from(TypeCaution.class).where(TypeCaution_Table.id.eq(id)).querySingle();
        final Dialog dialog = new Dialog(context);
        dialog.setCancelable(false);
        dialog.setContentView(R.layout.add_type_de_caution);
        // Initialisation du formulaire
        ...
        final Button valider = (Button) dialog.findViewById(R.id.valider);
        final Button annuler = (Button) dialog.findViewById(R.id.annuler);
        libelle.setText(caracteristique.getLibelle().toString());
        valider.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
/*
    ...
    protected void setupPagination() {
        ...
        mAdapter = new TypeCautionAdapter(this, TypeCaution.findAll(), (OnItemClickListener) this);
        loading = false;
        page = 0;

        mAdapter = new TypeCautionAdapter(this, TypeCaution.getInitData(initItem), (OnItemClickListener) this);
        mRecyclerView.setAdapter(mAdapter);


        ((TypeCautionAdapter) mAdapter).setMode(Attributes.Mode.Single);
    ...
    public boolean onQueryTextChange(String query) {
        final List<TypeCaution> filteredModelList = filter(TypeCaution.findAll(), query);
    ...
    private List<TypeCaution> filter(List<TypeCaution> models, String query) {
        query = query.toLowerCase();
        System.out.println(models);
        final List<TypeCaution> filteredModelList = new ArrayList<>();
        for (TypeCaution model : models) {
