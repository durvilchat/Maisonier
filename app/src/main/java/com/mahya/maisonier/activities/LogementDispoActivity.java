...
public class LogementDispoActivity extends BaseActivity implements CrudActivity, SearchView.OnQueryTextListener,
        OnItemClickListener {

    private static final String TAG = LogementDispoActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new LogementAdapter(this, (ArrayList<Logement>) Logement.findLogementDispo(), this);
