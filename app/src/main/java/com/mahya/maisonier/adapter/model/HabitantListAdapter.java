...
public class HabitantListAdapter extends RecyclerSwipeAdapter<HabitantListAdapter.SimpleViewHolder> {


    private static final String TAG = HabitantListAdapter.class.getSimpleName();
    Context mContext;
    int idSelect;
    int selectposition;
    ...
    public HabitantListAdapter(Context context, List<Habitant> habitants, OnItemClickListener clickListener) {
        ...
        try {
            ...
            viewHolder.img.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (mContext instanceof HabitantListActivity) {
                        ((HabitantListActivity) mContext).onItemClicked(position);
...
// Span the item if active
        ...
        viewHolder.swipeLayout.getSurfaceView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mContext instanceof HabitantListActivity) {
                    if (mContext instanceof HabitantListActivity) {
                        ((HabitantListActivity) mContext).start(idSelect);
                    }
                }
            }
        });
        ...
        viewHolder.swipeLayout.getSurfaceView().setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                idSelect = Integer.parseInt(id.getText().toString());
                ((HabitantListActivity) mContext).onItemLongClicked(position);
        ...
        viewHolder.detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((HabitantListActivity) mContext).detail(idSelect);
        ...
        viewHolder.call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((HabitantListActivity) mContext).call(contqct);
                mItemManger.closeAllExcept(null);
            }
        });
        ...
        viewHolder.tvEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((HabitantListActivity) mContext).modifier(idSelect);
                mItemManger.closeAllExcept(null);
        ...
        viewHolder.tvDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((HabitantListActivity) mContext).supprimer(idSelect);
                mItemManger.closeAllExcept(null);
